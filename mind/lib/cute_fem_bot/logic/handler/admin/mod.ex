defmodule CuteFemBot.Logic.Handler.Admin do
  ...
  over_if_command("web", &command_web/1)
  over_if_command("posting_mode", &command_posting_mode/1)
  over_if_command("help", &command_help/1)
  over_if_command("unban", &command_unban/1)
